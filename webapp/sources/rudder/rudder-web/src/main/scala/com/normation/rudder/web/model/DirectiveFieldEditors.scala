...
class TextField(
  ...
  def name = id
  def validate:               scala.collection.immutable.Nil.type = Nil
  def validations:            scala.collection.immutable.Nil.type = Nil
  def setFilter:              scala.collection.immutable.Nil.type = Nil
