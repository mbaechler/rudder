...
class SettingsApi(
  ...
  case object RestModifiedFileTTL             extends RestIntSetting                          {
    ...
    def set: (Int, EventActor, Option[String]) => IOResult[Unit]                   = (value: Int, _, _) => configService.set_cfengine_modified_files_ttl(value)
  }
  case object RestOutputFileTTL               extends RestIntSetting                          {
    ...
    def set: (Int, EventActor, Option[String]) => IOResult[Unit]                   = (value: Int, _, _) => configService.set_cfengine_outputs_ttl(value)
  }
  case object RestReportingMode               extends RestSetting[ComplianceModeName]         {
    ...
    def set: (ComplianceModeName, EventActor, Option[String]) => IOResult[Unit]                       = (value: ComplianceModeName, actor: EventActor, reason: Option[String]) =>
  ...
  case object RestChangeMessageEnabled        extends RestBooleanSetting                      {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_ui_changeMessage_enabled(value)
  }
  case object RestChangeMessageManadatory     extends RestBooleanSetting                      {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_ui_changeMessage_mandatory(value)
  }
  case object RestChangeMessagePrompt         extends RestStringSetting                       {
    ...
    def set: (String, EventActor, Option[String]) => IOResult[Unit]                   = (value: String, _, _) => configService.set_rudder_ui_changeMessage_explanation(value)
  }
  case object RestChangeRequestEnabled        extends RestBooleanSetting                      {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_workflow_enabled(value)
  }
  case object RestChangeRequestSelfDeployment extends RestBooleanSetting                      {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_workflow_self_deployment(value)
  }
  case object RestChangeRequestSelfValidation extends RestBooleanSetting                      {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_workflow_self_validation(value)
  }
  case object RestRequireTimeSynch            extends RestBooleanSetting                      {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_cfengine_server_denybadclocks(value)
  }
  case object RestRelaySyncMethod             extends RestSetting[RelaySynchronizationMethod] {
    ...
    def set: (RelaySynchronizationMethod, EventActor, Option[String]) => IOResult[Unit]                   = (value: RelaySynchronizationMethod, _, _) => configService.set_relay_server_sync_method(value)
  ...
  case object RestRelaySynchronizePolicies    extends RestBooleanSetting                      {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_relay_server_syncpromises(value)
  }
  case object RestRelaySynchronizeSharedFiles extends RestBooleanSetting                      {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_relay_server_syncsharedfiles(value)
  }
  ...
  case object RestReportProtocolDefault extends RestSetting[AgentReportingProtocol] {
    ...
    def set: (AgentReportingProtocol, EventActor, Option[String]) => IOResult[Unit]                   = (value: AgentReportingProtocol, _, _) => configService.set_rudder_report_protocol_default(value)
  ...
  case object RestChangesGraphs extends RestBooleanSetting {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_display_changes_graph(value)
  }
  ...
  case object RestJSEngine extends RestSetting[FeatureSwitch] {
    ...
    def set: (FeatureSwitch, EventActor, Option[String]) => IOResult[Unit]                       = (value: FeatureSwitch, _, _) => configService.set_rudder_featureSwitch_directiveScriptEngine(value)
  }
  ...
  case object RestOnAcceptPolicyMode extends RestSetting[Option[PolicyMode]] {
    ...
    def set: (Option[PolicyMode], EventActor, Option[String]) => IOResult[Unit]                     = (value: Option[PolicyMode], _, _) => configService.set_rudder_node_onaccept_default_policy_mode(value)
  }
  ...
  case object RestOnAcceptNodeState extends RestSetting[NodeState] {
    ...
    def set: (NodeState, EventActor, Option[String]) => IOResult[Unit]                     = (value: NodeState, _, _) => configService.set_rudder_node_onaccept_default_state(value)
  }

  trait RestChangeUnexpectedReportInterpretation extends RestBooleanSetting {
    def prop: UnexpectedReportBehavior
    def get: ZIO[Any,RudderError,Boolean] = configService.rudder_compliance_unexpected_report_interpretation().map(_.isSet(prop))
  ...
  case object RestComputeChanges extends RestBooleanSetting {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_compute_changes(value)
  }
  ...
  case object RestGenerationComputeDynGroups extends RestBooleanSetting {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_generation_compute_dyngroups(value)
  }
  ...
  case object RestPersistComplianceLevels extends RestBooleanSetting {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_save_db_compliance_levels(value)
  }
  ...
  case object RestPersistComplianceDetails extends RestBooleanSetting {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_save_db_compliance_details(value)
  }
  case object RestGenerationMaxParallelism extends RestStringSetting  {
    ...
    def set: (String, EventActor, Option[String]) => IOResult[Unit]                   = (value: String, _, _) => configService.set_rudder_generation_max_parallelism(value)
  }
  ...
  case object RestGenerationDelay extends RestSetting[Duration] {
    ...
    def set: (Duration, EventActor, Option[String]) => IOResult[Unit]                   = (value: Duration, _, _) => configService.set_rudder_generation_delay(value)
  ...
  case object RestPolicyGenerationTrigger extends RestSetting[PolicyGenerationTrigger] {
    ...
    def set: (PolicyGenerationTrigger, EventActor, Option[String]) => IOResult[Unit]                   = (value: PolicyGenerationTrigger, _, _) => configService.set_rudder_generation_trigger(value)
  ...
  case object RestGenerationJsTimeout extends RestIntSetting {
    ...
    def set: (Int, EventActor, Option[String]) => IOResult[Unit]                   = (value: Int, _, _) => configService.set_rudder_generation_js_timeout(value)
  }
  ...
  case object RestContinueGenerationOnError extends RestBooleanSetting {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_generation_continue_on_error(value)
  }
  ...
  case object RestNodeAcceptDuplicatedHostname extends RestBooleanSetting {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_node_accept_duplicated_hostname(value)
  }
  ...
  case object RestComputeDynGroupMaxParallelism extends RestStringSetting {
    ...
    def set: (String, EventActor, Option[String]) => IOResult[Unit]                   = (value: String, _, _) => configService.set_rudder_compute_dyngroups_max_parallelism(value)
  }
  ...
  case object RestSetupDone extends RestBooleanSetting {
    ...
    def set: (Boolean, EventActor, Option[String]) => IOResult[Unit]                   = (value: Boolean, _, _) => configService.set_rudder_setup_done(value)
  }
