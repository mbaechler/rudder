...
class TechniqueApi(
  ...
  import zio.json._
  import zio.json.yaml._
  def schemas: com.normation.rudder.rest.TechniqueApi.type = API
  ...
  object GetTechniques extends LiftApiModule0 {
    val schema:                                                                                                com.normation.rudder.rest.TechniqueApi.GetTechniques.type = API.GetTechniques
    implicit val dataName:                                                                                     String                                                    = "techniques"
  ...
  object GetMethods extends LiftApiModule0 {
    ...
    val schema: com.normation.rudder.rest.TechniqueApi.GetMethods.type = API.GetMethods
    val restExtractor = restExtractorService
  ...
  object UpdateMethods extends LiftApiModule0 {
    ...
    val schema: com.normation.rudder.rest.TechniqueApi.UpdateMethods.type = API.UpdateMethods
    val restExtractor = restExtractorService
    implicit val dataName: String = "methods"
  ...
  object UpdateTechniques extends LiftApiModule0 {
    ...
    val schema: com.normation.rudder.rest.TechniqueApi.UpdateTechniques.type = API.UpdateTechniques
    val restExtractor = restExtractorService
    implicit val dataName: String = "techniques"
  ...
  object GetAllTechniqueCategories extends LiftApiModule0 {
    ...
    val schema: com.normation.rudder.rest.TechniqueApi.GetAllTechniqueCategories.type = API.GetAllTechniqueCategories
    val restExtractor = restExtractorService
  ...
  object CreateTechnique extends LiftApiModule0 {
    ...
    val schema: com.normation.rudder.rest.TechniqueApi.CreateTechnique.type = API.CreateTechnique
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
  ...
  object ListTechniques extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.TechniqueApi.ListTechniques.type = API.ListTechniques
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
      response(
        restExtractor,
  ...
  object CheckTechnique extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.TechniqueApi.CheckTechnique.type = API.CheckTechnique
    val restExtractor = restExtractorService
    implicit val dataName:                                                                                     String       = "techniques"
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
      def charset: String = RestUtils.getCharset(req)
  ...
  object ListTechniquesDirectives extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.TechniqueApi.ListTechniquesDirectives.type = API.ListTechniquesDirectives
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object ListTechniqueDirectives extends LiftApiModuleString2 {
    val schema: com.normation.rudder.rest.TechniqueApi.ListTechniqueDirectives.type = API.ListTechniqueDirectives
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object GetTechniqueDetailsAllVersion extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.TechniqueApi.GetTechniqueAllVersion.type = API.GetTechniqueAllVersion
    def process(
        version:    ApiVersion,
        path:       ApiPath,
        name:       String,
  ...
  object GetTechnique extends LiftApiModuleString2 {
    val schema: com.normation.rudder.rest.TechniqueApi.GetTechnique.type = API.GetTechnique
    def process(
        version:    ApiVersion,
        path:       ApiPath,
        nv:         (String, String),
  ...
  object TechniqueRevisions extends LiftApiModuleString2 {
    val schema: com.normation.rudder.rest.TechniqueApi.TechniqueRevisions.type = API.TechniqueRevisions
    def process(
        version:    ApiVersion,
        path:       ApiPath,
        nv:         (String, String),
