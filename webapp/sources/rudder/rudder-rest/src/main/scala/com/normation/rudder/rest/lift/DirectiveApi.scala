...
class DirectiveApi(
  ...
  def schemas: com.normation.rudder.rest.DirectiveApi.type = API
  ...
  object ListDirective extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.DirectiveApi.ListDirectives.type = API.ListDirectives
  ...
  object DirectiveDetails extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.DirectiveApi.DirectiveDetails.type = API.DirectiveDetails
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object CreateDirective extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.DirectiveApi.CreateDirective.type = API.CreateDirective
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
  ...
  object DeleteDirective extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.DirectiveApi.DeleteDirective.type = API.DeleteDirective
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object CheckDirective extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.DirectiveApi.CheckDirective.type = API.CheckDirective
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object UpdateDirective extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.DirectiveApi.UpdateDirective.type = API.UpdateDirective
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object DirectiveTree    extends LiftApiModule0 {
    val schema:                                                                                                com.normation.rudder.rest.DirectiveApi.DirectiveTree.type = API.DirectiveTree
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse                                              = {
      (for {
  ...
  object DirectiveRevisionsV14 extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.DirectiveApi.DirectiveRevisions.type = API.DirectiveRevisions
    def process(
        version:    ApiVersion,
        path:       ApiPath,
        id:         String,
