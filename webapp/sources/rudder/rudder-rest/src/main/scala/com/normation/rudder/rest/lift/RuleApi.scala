...
class RuleApi(
  ...
  def schemas: com.normation.rudder.rest.RuleApi.type = API
  ...
  object ListRules extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.RuleApi.ListRules.type = API.ListRules
  ...
  object CreateRule extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.RuleApi.CreateRule.type = API.CreateRule
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
  ...
  object RuleDetails extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.RuleApi.RuleDetails.type = API.RuleDetails
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object DeleteRule extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.RuleApi.DeleteRule.type = API.DeleteRule
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object UpdateRule extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.RuleApi.UpdateRule.type = API.UpdateRule
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object GetRuleTree extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.RuleApi.GetRuleTree.type = API.GetRuleTree
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
      response(
  ...
  object GetRuleCategoryDetails extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.RuleApi.GetRuleCategoryDetails.type = API.GetRuleCategoryDetails
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object DeleteRuleCategory extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.RuleApi.DeleteRuleCategory.type = API.DeleteRuleCategory
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object UpdateRuleCategory extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.RuleApi.UpdateRuleCategory.type = API.UpdateRuleCategory
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object CreateRuleCategory extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.RuleApi.CreateRuleCategory.type = API.CreateRuleCategory
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
  ...
  object LoadRuleRevisionForGeneration extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.RuleApi.LoadRuleRevisionForGeneration.type = API.LoadRuleRevisionForGeneration
    def process(
        version:    ApiVersion,
        path:       ApiPath,
        id:         String,
  ...
  object UnloadRuleRevisionForGeneration extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.RuleApi.UnloadRuleRevisionForGeneration.type = API.UnloadRuleRevisionForGeneration
    def process(
        version:    ApiVersion,
        path:       ApiPath,
        id:         String,
