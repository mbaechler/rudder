...
class LiftHandler(
  ...
  val logger: com.normation.rudder.rest.lift.LiftApiProcessingLogger.type = LiftApiProcessingLogger

  private[this] var _apis = List.empty[LiftApiModule]
  def apis():                                   List[com.normation.rudder.rest.lift.LiftApiModule] = _apis
