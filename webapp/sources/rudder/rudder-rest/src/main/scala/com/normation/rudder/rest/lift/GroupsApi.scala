...
class GroupsApi(
  ...
  def schemas: com.normation.rudder.rest.GroupApi.type = API
  ...
  object List extends LiftApiModule0      {
    val schema:                                                                                                com.normation.rudder.rest.GroupApi.ListGroups.type = API.ListGroups
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse                                       = {
      serviceV14.listGroups().toLiftResponseList(params, schema)
    }
  }
  object Get  extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.GroupDetails.type = API.GroupDetails
    def process(
        version:    ApiVersion,
        path:       ApiPath,
        sid:        String,
  ...
  object GroupInheritedProperties extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.GroupInheritedProperties.type = API.GroupInheritedProperties
  ...
  object GroupDisplayInheritedProperties extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.GroupDisplayInheritedProperties.type = API.GroupDisplayInheritedProperties
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object Delete extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.DeleteGroup.type = API.DeleteGroup
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object Create extends LiftApiModule0      {
    val schema: com.normation.rudder.rest.GroupApi.CreateGroup.type = API.CreateGroup
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
      if (req.json_?) {
        req.json match {
  ...
  object Update extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.UpdateGroup.type = API.UpdateGroup
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object Reload extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.ReloadGroup.type = API.ReloadGroup
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object GetTree        extends LiftApiModule0      {
    val schema: com.normation.rudder.rest.GroupApi.GetGroupTree.type = API.GetGroupTree
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
  ...
  object GetCategory    extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.GetGroupCategoryDetails.type = API.GetGroupCategoryDetails
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object DeleteCategory extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.DeleteGroupCategory.type = API.DeleteGroupCategory
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object UpdateCategory extends LiftApiModuleString {
    val schema: com.normation.rudder.rest.GroupApi.UpdateGroupCategory.type = API.UpdateGroupCategory
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object CreateCategory extends LiftApiModule0      {
    val schema: com.normation.rudder.rest.GroupApi.CreateGroupCategory.type = API.CreateGroupCategory
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
      implicit val action = schema.name
