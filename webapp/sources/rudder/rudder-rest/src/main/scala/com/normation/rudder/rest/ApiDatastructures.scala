...
trait PublicApi   extends EndpointSchema { val kind: com.normation.rudder.rest.ApiKind.Public.type = ApiKind.Public     }
trait InternalApi extends EndpointSchema { val kind: com.normation.rudder.rest.ApiKind.Internal.type = ApiKind.Internal }
trait GeneralApi  extends EndpointSchema { val kind: com.normation.rudder.rest.ApiKind.General.type = ApiKind.General   }
