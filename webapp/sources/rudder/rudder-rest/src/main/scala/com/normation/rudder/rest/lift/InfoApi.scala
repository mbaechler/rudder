...
class InfoApi(
  ...
  def schemas: com.normation.rudder.rest.InfoApi.type = API
  ...
  object ApiGeneralInformations extends LiftApiModule0 {
    val schema: com.normation.rudder.rest.InfoApi.ApiGeneralInformations.type = API.ApiGeneralInformations
