...
class LoadDemoDataTest extends Specification {
  ...
  val ldap: InMemoryDsConnectionProvider[RwLDAPConnection with RoLDAPConnection] = InitTestLDAPServer.newLdapConnectionProvider(InitTestLDAPServer.schemaLDIFs, bootstrapLDIFs)
...
object InitTestLDAPServer {
  ...
  def newLdapConnectionProvider(schema: List[String], fullLdifPaths: List[String]): InMemoryDsConnectionProvider[RwLDAPConnection with RoLDAPConnection] = {
