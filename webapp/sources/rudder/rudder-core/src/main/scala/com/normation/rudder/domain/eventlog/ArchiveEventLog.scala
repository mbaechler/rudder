...
sealed trait ImportExportEventLog extends EventLog {
  final override val eventLogCategory: com.normation.rudder.domain.eventlog.ImportExportItemsLogCategory.type =
    ImportExportItemsLogCategory
}
...
final case class ExportGroupsArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ExportGroupsEventType.type = ExportGroupsArchive.eventType
...
object ExportGroupsArchive extends EventLogFilter {
  override val eventType: com.normation.rudder.domain.eventlog.ExportGroupsEventType.type = ExportGroupsEventType
...
final case class ImportGroupsArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ImportGroupsEventType.type = ImportGroupsArchive.eventType
...
object ImportGroupsArchive extends EventLogFilter {
  override val eventType: com.normation.rudder.domain.eventlog.ImportGroupsEventType.type = ImportGroupsEventType
...
final case class ExportTechniqueLibraryArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ExportTechniqueLibraryEventType.type =
    ExportTechniqueLibraryArchive.eventType
...
final case class ImportTechniqueLibraryArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ImportTechniqueLibraryEventType.type =
    ImportTechniqueLibraryArchive.eventType
...
final case class ExportRulesArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ExportRulesEventType.type = ExportRulesArchive.eventType
...
object ExportRulesArchive extends EventLogFilter {
  override val eventType: com.normation.rudder.domain.eventlog.ExportRulesEventType.type = ExportRulesEventType
...
final case class ImportRulesArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ImportRulesEventType.type = ImportRulesArchive.eventType
...
object ImportRulesArchive extends EventLogFilter {
  override val eventType: com.normation.rudder.domain.eventlog.ImportRulesEventType.type = ImportRulesEventType
...
final case class ExportParametersArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ExportParametersEventType.type = ExportParametersArchive.eventType
...
object ExportParametersArchive extends EventLogFilter {
  override val eventType: com.normation.rudder.domain.eventlog.ExportParametersEventType.type = ExportParametersEventType
...
final case class ImportParametersArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ImportParametersEventType.type = ImportParametersArchive.eventType
...
object ImportParametersArchive extends EventLogFilter {
  override val eventType: com.normation.rudder.domain.eventlog.ImportParametersEventType.type = ImportParametersEventType
...
final case class ExportFullArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ExportFullArchiveEventType.type = ExportFullArchive.eventType
...
object ExportFullArchive extends EventLogFilter {
  override val eventType: com.normation.rudder.domain.eventlog.ExportFullArchiveEventType.type = ExportFullArchiveEventType
...
final case class ImportFullArchive(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.ImportFullArchiveEventType.type = ImportFullArchive.eventType
...
object ImportFullArchive extends EventLogFilter {
  override val eventType: com.normation.rudder.domain.eventlog.ImportFullArchiveEventType.type = ImportFullArchiveEventType
...
final case class Rollback(
  ...
  override val eventType: com.normation.rudder.domain.eventlog.RollbackEventType.type = RollbackEventType
