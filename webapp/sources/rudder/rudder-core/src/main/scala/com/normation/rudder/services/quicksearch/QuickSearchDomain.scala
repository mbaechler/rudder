...
object QuickSearchResultId {
  ...
  final case class QRNodeId(value: String)      extends AnyVal with QuickSearchResultId {
    override def tpe: com.normation.rudder.services.quicksearch.QSObject.Node.type = Node
  }
  final case class QRGroupId(value: String)     extends AnyVal with QuickSearchResultId {
    override def tpe: com.normation.rudder.services.quicksearch.QSObject.Group.type = Group
  }
  final case class QRDirectiveId(value: String) extends AnyVal with QuickSearchResultId {
    override def tpe: com.normation.rudder.services.quicksearch.QSObject.Directive.type = Directive
  }
  final case class QRParameterId(value: String) extends AnyVal with QuickSearchResultId {
    override def tpe: com.normation.rudder.services.quicksearch.QSObject.Parameter.type = Parameter
  }
  final case class QRRuleId(value: String)      extends AnyVal with QuickSearchResultId {
    override def tpe: com.normation.rudder.services.quicksearch.QSObject.Rule.type = Rule
  }
}
